      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-neutral-900 border border-neutral-700 rounded-2xl p-6 mb-6">
          <div className="flex space-x-3">
            ...
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3.5 rounded-xl font-semibold transition-colors duration-200 flex items-center space-x-2">
          ...
          <div className="mt-6">
            ...
            <div className="w-full bg-neutral-700 rounded-full h-2">
              <div
                ...
                style={{
                  width: (completedTodos.length / mockTodos.length) * 100 + "%",
                }}></div>
            </div>
          </div>
        </div>
